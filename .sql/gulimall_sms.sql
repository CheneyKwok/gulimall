...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (1, 1, 2, '铜牌会员', 7800.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 1, 3, '银牌会员', 7700.0000, 1);
INSERT INTO `sms_member_price` VALUES (3, 1, 4, '金牌会员', 7500.0000, 1);
INSERT INTO `sms_member_price` VALUES (4, 3, 2, '铜牌会员', 7800.0000, 1);
INSERT INTO `sms_member_price` VALUES (5, 3, 3, '银牌会员', 7600.0000, 1);
INSERT INTO `sms_member_price` VALUES (6, 3, 4, '金牌会员', 7500.0000, 1);
...
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 5000.0000, 300.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (2, 3, 5000.0000, 300.0000, NULL);
...
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 3, 0.98, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (2, 3, 5, 0.98, NULL, 0);
