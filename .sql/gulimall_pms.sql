...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(1) NULL DEFAULT NULL,
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '入网型号', 1, 'xxxx', 'aa;vv', 1, 1, 225, 1, 1);
INSERT INTO `pms_attr` VALUES (2, '上市年份', 0, 'xx', '2020;2021', 1, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (3, '颜色', 0, 'xxxxx', '黑色;白色;红色', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (4, '内存', 0, 'xxx', '4GB;6GB;8GB', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (5, '机身颜色', 0, 'xx', '黑色;白色', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (6, '机身长度（mm）', 0, 'xxx', '158.2', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (7, '机身材质工艺', 0, 'xx', '陶瓷;玻璃', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (8, 'CPU品牌', 0, 'xxx', '其他', 1, 1, 225, 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 6, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 7, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (12, 1, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (13, 2, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (14, 5, 4, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (15, 8, 5, NULL);
...
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (2, '主体', 0, '主体', 'xxx', 225);
INSERT INTO `pms_attr_group` VALUES (4, '基本信息', 0, '基本信息', 'zzz', 225);
INSERT INTO `pms_attr_group` VALUES (5, '主芯片', 0, '主芯片', 'xx', 225);
...
-- ----------------------------
INSERT INTO `pms_brand` VALUES (1, '华为', 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-09/1345af6b-98c9-4277-8623-47b8a002ab66_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (2, '小米', 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-09/047724ff-7e7b-4f3e-879a-fdd63ee5add5_xiaomi.png', '小米', 1, 'M', 1);
INSERT INTO `pms_brand` VALUES (3, '苹果', 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-09/7d680ab6-9852-4111-81f4-db838f4b09ee_apple.png', '苹果', 1, 'P', 1);
INSERT INTO `pms_brand` VALUES (4, 'Oppo', 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-09/d114e3ec-318d-49a4-8066-d37e8fbbc7c1_oppo.png', 'Oppo', 1, 'O', 1);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (2, 1, 452, '华为', '平板电脑');
INSERT INTO `pms_category_brand_relation` VALUES (3, 1, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 2, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 3, 225, '苹果', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 4, 225, 'Oppo', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 1, 170, '华为', '影视');
INSERT INTO `pms_category_brand_relation` VALUES (8, 1, 170, '华为', '影视');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (9, 1, 1, '入网型号', 'aa', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (10, 1, 2, '上市年份', '2021', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (11, 1, 5, '机身颜色', '黑色', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (12, 1, 6, '机身长度（mm）', '158.2', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (13, 1, 7, '机身材质工艺', '陶瓷', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (14, 1, 8, 'CPU品牌', '其他', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//ec9ff08c-df99-45f3-8bf2-25368cf03e4b_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//941859a1-666b-42e8-8c07-89cd18ff0cd4_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (3, 2, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//ec9ff08c-df99-45f3-8bf2-25368cf03e4b_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (4, 2, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//941859a1-666b-42e8-8c07-89cd18ff0cd4_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (5, 3, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//01c4bef1-b717-4f94-8495-2246e2e71da8_d511faab82abb34b.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (6, 3, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//1a42fe72-180e-4d88-8521-74ada5be26f3_919c850652e98031.jpg', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 1, '华为 HUAWEI P40 Pro', NULL, 225, 1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//ec9ff08c-df99-45f3-8bf2-25368cf03e4b_8bf441260bffa42f.jpg', '华为 HUAWEI P40 Pro+ 麒麟990 5G SoC芯片 5000万超感知徕卡五摄 100倍双目变焦 8GB+256GB陶瓷黑全网通5G', '至高6期免息，麒麟990芯片；5000万超感知徕卡四摄；100倍双目变焦；华为手机全场至高6期免息查看>', 7988.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 1, '华为 HUAWEI P40 Pro', NULL, 225, 1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//ec9ff08c-df99-45f3-8bf2-25368cf03e4b_8bf441260bffa42f.jpg', '华为 HUAWEI P40 Pro+ 麒麟990 5G SoC芯片 5000万超感知徕卡五摄 100倍双目变焦 8GB+256GB陶瓷黑全网通5G', '至高6期免息，麒麟990芯片；5000万超感知徕卡四摄；100倍双目变焦；华为手机全场至高6期免息查看>', 7988.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 1, '华为 HUAWEI P40 Pro', NULL, 225, 1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//01c4bef1-b717-4f94-8495-2246e2e71da8_d511faab82abb34b.jpg', '华为 HUAWEI P40 Pro+ 麒麟990 5G SoC芯片 5000万超感知徕卡五摄 100倍双目变焦 8GB+256GB陶瓷白全网通5G', '至高6期免息，麒麟990芯片；5000万超感知徕卡四摄；100倍双目变焦；华为手机全场至高6期免息查看>', 8888.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 1, '华为 HUAWEI P40 Pro', NULL, 225, 1, '', '华为 HUAWEI P40 Pro+ 麒麟990 5G SoC芯片 5000万超感知徕卡五摄 100倍双目变焦 8GB+256GB陶瓷白全网通5G', '至高6期免息，麒麟990芯片；5000万超感知徕卡四摄；100倍双目变焦；华为手机全场至高6期免息查看>', 8888.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 3, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 4, '内存', '8GB+512GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 3, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 4, '内存', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 3, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 4, '内存', '8GB+512GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 3, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 4, '内存', '8GB+256GB', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (1, 1, NULL, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//ec9ff08c-df99-45f3-8bf2-25368cf03e4b_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (2, 1, NULL, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//941859a1-666b-42e8-8c07-89cd18ff0cd4_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (3, 1, NULL, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//01c4bef1-b717-4f94-8495-2246e2e71da8_d511faab82abb34b.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (4, 1, NULL, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//1a42fe72-180e-4d88-8521-74ada5be26f3_919c850652e98031.jpg', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (1, '华为 HUAWEI P40 Pro', '华为 HUAWEI P40 Pro+ 麒麟990 5G', 225, 1, 0.1980, 1, '2021-01-12 11:31:00', '2021-01-12 11:31:00');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (1, 'https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//fbe41c4e-7a5c-47fe-8de9-2f59cfd8aadb_0d40c24b264aa511.jpg，https://gulimall-gzc.oss-cn-hangzhou.aliyuncs.com/2021-01-12//870ad46a-56b9-427c-8cf1-31d41cb4c23f_528211b97272d88a.jpg');
